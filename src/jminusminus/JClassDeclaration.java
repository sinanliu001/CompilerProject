...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    public void declareThisType(Context context) {
        ...
        if (superInterfaces!=null){
            for (TypeName interfacename: superInterfaces){
                interfacelist.add(interfacename.toString());
            }
        }
        partial.addClass(mods, qualifiedName, Type.OBJECT.jvmName(), interfacelist, false);
